...
echo.
echo !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
echo IMPORTANT: Although you can use docker-compose to run multiple servers in Windows, the default macvlan network driver does not work correctly in Windows.  Thus you will not by default have access to the servers on your LAN.  You will need to figure out the networking yourself, or switch to a Linux host for multiple servers.  
echo !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
echo.
